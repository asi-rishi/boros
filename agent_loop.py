...
class AgentLoop:
    ...
    def _cycle_prompt(self):
        return (
            ...
            "8. Read the target file with `tool_terminal` (e.g. `type skills\\<skill>\\functions\\<file>.py`)\n"
            "9. Write REAL Python code improvements using `tool_file_edit_diff` or `forge_apply_diff`\n"
